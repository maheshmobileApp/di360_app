class GetNewsFeedCategoriesRes {
  NewsFeedCategoriesData? data;

  GetNewsFeedCategoriesRes({this.data});

  GetNewsFeedCategoriesRes.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new NewsFeedCategoriesData.fromJson(json['data']) : null;
  }
...
class NewsFeedCategoriesData {
  List<NewsfeedCategories>? newsfeedCategories;

  NewsFeedCategoriesData({this.newsfeedCategories});

  NewsFeedCategoriesData.fromJson(Map<String, dynamic> json) {
