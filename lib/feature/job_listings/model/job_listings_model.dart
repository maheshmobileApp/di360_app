...
class JobsListingDetails {
  ...
  JobsListingDetails.fromJson(Map<String, dynamic> json) {
    ...
    //   json['clinic_logo'].forEach((v) {
    //     clinicLogo!.add(new ClinicLogo.fromJson(v));
    //   });
    // }
    if (json['clinic_logo'] != null) {
      if (json['clinic_logo'] is List) {
        ...
        // When it's just a single string URL
    ...
    jobApplicantsAggregate = json['job_applicants_aggregate'] != null
        ? new JobApplicantsAggregate.fromJson(json['job_applicants_aggregate'])
        : null;
  }
