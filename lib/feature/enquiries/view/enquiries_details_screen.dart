...
class EnquiriesDetailsScreen extends StatelessWidget with BaseContextHelpers {
  final EnquiriesJob appliedJob;
  const EnquiriesDetailsScreen({
    super.key,
  ...
  Widget _buildBodyContent(
      BuildContext context, EnquiryJob? job, String time, String logoUrl) {
    return Column(
  ...
  Widget _infoCard(EnquiryJob? job) {
    return Container(
  ...
  Widget locationView(BuildContext context, EnquiryJob? job) {
  ...
  Future<void> _openLocationInMaps(BuildContext context, EnquiryJob? job) async {
