...
class _FileUploadWidgetState extends State<UploadFileWidget> {
  ...
  Widget _buildFilePreview(
      PlatformFile file, int index, NewsFeedCommunityViewModel viewModel) {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text("Upload File", style: TextStyles.regular3(color: AppColors.black),),
        SizedBox(height: 10),
        GestureDetector(
