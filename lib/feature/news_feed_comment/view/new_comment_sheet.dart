...
class NewCommentSheet extends StatefulWidget with BaseContextHelpers {
  final Newsfeeds? newsfeeds;
  const NewCommentSheet({super.key, this.newsfeeds});

  @override
  State<NewCommentSheet> createState() => _CommentBottomSheetState();
}

class _CommentBottomSheetState extends State<NewCommentSheet>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _initializeSortedComments(viewModel.newsFeedComments?.newsFeedsComments);
    });
  }

  void _initializeSortedComments(List<NewsFeedsComments>? comments) {
    if (comments != null && comments.isNotEmpty) {
      _sortedComments = List.from(comments);
  ...
  @override
  void didUpdateWidget(NewCommentSheet oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final currentComments = viewModel.newsFeedComments?.newsFeedsComments;
  ...
  Widget _buildCommentTile(NewsFeedsComments? comments,
    ...
    final replyCount = comments.repliesAggregate?.aggregate?.count.toString();
      ...
      child: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return NewReplyCommentWidget(comments: reply, feedId: feedId);
          },
        ),
      ),
    );
