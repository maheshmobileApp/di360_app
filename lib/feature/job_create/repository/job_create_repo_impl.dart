...
import 'package:di360_flutter/feature/job_create/querys/update_job_query.dart';
...
class JobCreateRepoImpl extends JobCreateRepository {
  ...
  @override
  Future updateJobListing(variables) async {
    final res = await http.mutation(updateJobQuery, variables);
    return res;
  }
}
