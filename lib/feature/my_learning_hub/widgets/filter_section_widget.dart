...
class FilterBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => FilterViewModel(sections: sections),
                  ...
                  children: [
                    ...
                    ...sections.map(
                      (section) => _FilterSection(
                        ...
                        onOptionSelected: (value) => vm.selectOption(section.title, value),
                      ),
                    ),
                    const SizedBox(height: 8),
                    CustomDatePicker(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: AppButton(
                            ...
                            text: 'Apply',
                            onTap: () {
                              vm.updateLocation(vm.locationController.text);
                              onApply(vm.selectedOptions);
                              navigationService.goBack();
                            },
                          ),
                        ),
