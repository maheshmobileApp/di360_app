class GetAllNewsFeedsCategories {
  CategoriesData? data;

  GetAllNewsFeedsCategories({this.data});

  GetAllNewsFeedsCategories.fromJson(Map<String, dynamic> json) {
