...
class _UploadImageFieldState extends State<UploadImageField> {
  Widget _fileCard(Widget child, int index, SupportViewModel viewModel,
  ...
  Widget _buildFilePreview(
      PlatformFile file, int index, SupportViewModel viewModel) {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text("Attachments", style: TextStyles.regular3(color: AppColors.black),),
        SizedBox(height: 10),
        GestureDetector(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.attach_file, size: 30, color: Colors.grey.shade600),
                SizedBox(height: 4),
                Text('Tap to select files', style: TextStyle(color: Colors.grey.shade600, fontSize: 12)),
              ],
            ),
          ),
        ),
        SizedBox(height: 10),
        if (viewModel.existingImages.isNotEmpty || viewModel.selectedFiles.isNotEmpty)
          Container(
            width: double.infinity,
            child: Wrap(
              spacing: 8,
  ...
  Widget _buildExistingImagePreview(
      PostImage image, int index, SupportViewModel viewModel) {
