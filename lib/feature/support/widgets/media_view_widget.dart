...
class MediaViewWidget extends StatefulWidget {
  final List<Attachments>? postImage;
  ...
  @override
  State<MediaViewWidget> createState() => _ImageViewerScreenState();
}

class _ImageViewerScreenState extends State<MediaViewWidget>
  ...
  Widget buildMediaContent(Attachments? media) {
    if (media == null) {
