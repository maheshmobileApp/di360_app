...
class CommunityCommentReplyWidget extends StatelessWidget with BaseContextHelpers {
  ...
  final String feedId;
   final int depth;
  const CommunityCommentReplyWidget({super.key, this.comments, required this.feedId, this.depth = 0});
  ...
  Widget _buildMenu(BuildContext context, NewsFeedCommunityCommentViewModel viewModel) {
