class GetBusinessTypeRes {
  BusinessTypeData? data;

  GetBusinessTypeRes({this.data});

  GetBusinessTypeRes.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new BusinessTypeData.fromJson(json['data']) : null;
  }
...
class BusinessTypeData {
  ...
  BusinessTypeData({this.directoryBusinessTypes});

  BusinessTypeData.fromJson(Map<String, dynamic> json) {
