...
import 'package:di360_flutter/feature/campaign/widgets/html_email_composer.dart';
...
class CreateCampaignView extends StatelessWidget
              ...
              child: Column(
                ...
                children: [
                  ...
                  (viewModel.selectedType == "SMS" )
                      ...
                      : HtmlEmailComposer(
                          subjectController: viewModel.emailSubjectController,
                          viewModel: viewModel,
                          onChange: (subject, html, design) {
                            
                            // ✅ Send HTML
                            // ✅ Store design JSON
                            viewModel.setHtmlEmailMessage(html);
                            viewModel.setHtmlEmailDesign(design);
                            print("***********************$design");
                            debugPrint(html);
  ...
  void _validateAndSave(BuildContext context, CampaignViewModel viewModel) {
    if (_formKey.currentState!.validate()) {
      ...
      /*if (viewModel.htmlEmailMessage.isEmpty) {
        scaffoldMessenger('Please enter message');
        return;
      }*/
